  ...
  signOut(auth).then(() => { 
    ...
    return (
        <div className="navbar">
          ...
          <div onClick={()=>{setIsClick(true)}} className="logo" ><img src={userState ? userState.profileImage:"https://img.freepik.com/free-vector/illustration-businessman_53876-5856.jpg?w=740&t=st=1703762229~exp=1703762829~hmac=73d5571272b4f165751eb67344b2d52d90f62f4dd435bc53f8718a4549565c81"} alt="" /></div>
          {
